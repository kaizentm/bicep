...
namespace Bicep.LangServer.UnitTests.Handlers
{
    ...
    public class BicepDecompileForPasteCommandHandlerTests
    {
        ...
        private BicepDecompileForPasteCommandHandler CreateHandler(LanguageServerMock server/*, ICompilationManager compilationManager*/)
        {
        ...
        private async Task TestDecompileForPaste(Options options)
        {
            ...
            //BicepCompilationManager compilationManager = BicepCompilationManagerHelper.CreateCompilationManager(documentUri, editorContentsWithPastedJson, true);
            LanguageServerMock server = new LanguageServerMock();
            var handler = CreateHandler(server/*, compilationManager*/);
